...
exports.seed = async function(knex, Promise) {
  ...
  return knex('users').insert([
    ...
    {first_name:"Yashira" , last_name:"Boyce", birthday:"3/17/1997", password: "Yaya", email:"yasirahboyce1@gmail.com", medicaid:"Yes", is_doula:"No", gender: "women", doula_skillset:"None"},
